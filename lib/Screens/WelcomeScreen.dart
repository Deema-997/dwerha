        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Column(
                children: <Widget>[
                  Text(getTranslate(context, 'title'),style: logoStyle,),
                  SizedBox(height: 5.0,),
                  Text(getTranslate(context, 'desc'),style: smallStyle,textAlign: TextAlign.center,)
                ],
              ),
              GestureDetector(
                onTap: (){
                ...
                child: Column(children: <Widget>[
                  Text(getTranslate(context, 'welcome'),style: logoStyle,),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: <Widget>[
                      Icon(Icons.skip_next,color: Color(text_color),size: 30.0,),
                      Text(getTranslate(context, 'skip'),style: smallStyle,)
                    ],
                  )
                ],),
              )
